    ...
    return h("div", {}, [
      h("div", { class: "" }, [
        h(
          ...
          {
            class:
              "grid md:grid-cols-2 gap-12 justify-center py-12 items-center",
          },
          [
            h("div", { class: "flex justify-end mb-4 md:mb-0" }, [
              renderNotFoundImg(this.color),
            ]),
            h("div", { class: "mb-4 md:mb-0" }, [
              ...
              h("div", { class: "flex justify-center md:justify-start" }, [
                h(
                  AtButton,
                  { color: this.btnColor, to: { path: "/" } },
                  { default: () => this.btnTitle }
                ),
              ]),
            ]),
          ]
