  ...
  const commentTypeFeed = (item) =>
    h("div", { class: "relative flex items-start space-x-3" }, [
      ...
      h("div", { class: "min-w-0 flex-1" }, [
        h("div", [
          h("div", { class: "text-sm" }, [
            h("span", { class: "font-medium text-gray-900" }, item.title),
          ]),
          h(
            "p",
        ...
        h("div", { class: "mt-2 text-sm text-gray-700" }, [
          h("p", item.content),
        ]),
      ]),
    ]);
      ...
      h("div", [
        h(
          "span",
          {
            class: [
              item.iconBgColor
                ? "bg-" + item.iconBgColor + "-500"
                : "bg-gray-400",
              "h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white",
              {
                "mx-1": props.items.some(
                  (item) => item.type && item.type === "comment"
                ),
              },
            ],
          },
        ...
        [
          h("div", [
            h("p", { class: "text-sm text-gray-500" }, [
              ...
              h(
                "span",
                { class: "font-medium text-gray-900 ml-1" },
                item.content
              ),
            ]),
          ]),
...
AtFeeds.props = {
  items: {
    ...
    validator: (items) => {
      return items.every(
        (item) =>
          hasOwnProperty(item, "title") && hasOwnProperty(item, "content")
      );
    },
  },
};
